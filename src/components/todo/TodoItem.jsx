...
export class TodoItem extends React.Component {
  handleDelete = () => {
    console.log(this.props.todoItem._id);
    this.props.handleDelete(this.props.todoItem._id);
  };
      ...
      <div className="todo-item">
        ...
        <div className="todo-footer">
          <div className="todo-actions">
            ...
            <div className="custom-tooltip">
              <FontAwesomeIcon icon="trash-alt" color="red" size="lg" onClick={this.handleDelete} />
